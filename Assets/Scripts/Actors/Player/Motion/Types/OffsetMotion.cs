...
using SnTerminal;
using UnityEngine;
using Scope = Inventory.Attachments.Scope;
...
namespace Actors.Player
{
    ...
    public class OffsetMotion: Motion
    {
        ...
        public override void Tick()
        {
            ...
            var itemAnimationDataBehaviour = weaponBehaviour.GetAnimationData();
            ...
            Scope scopeBehaviour = weaponAttachmentManagerBehaviour.GetScope();
