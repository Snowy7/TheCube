...
namespace Actors.Player
{
    ...
    public class RecoilMotion: Motion
    {
        ...
        [Tooltip("The character's PlayerInventory component.")] [SerializeField, NotNull]
        private PlayerInventory inventory;

        [Tooltip("The character's FPSCharacter component.")] [SerializeField, NotNull]
        private FPSCharacter character;

        [Title("Settings")] [Tooltip("The type of motion we want this component to apply.")] [SerializeField]
        ...
        public override void Tick()
        {
            ...
            var animationDataBehaviour = inventory.GetEquipped()?.GetAnimationData();
