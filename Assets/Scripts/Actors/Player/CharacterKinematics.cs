...
{
    /// <summary>
    /// This takes care of the FPS arma IK.
    /// Hack: In case it did not work do this:
    /// (Should be assigned after the default time in the excution order inside the poroject settings).
    /// </summary>
