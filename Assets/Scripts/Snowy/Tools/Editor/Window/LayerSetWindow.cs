...
using Snowy.CSharp;
using Snowy.Tools;
using SnowyEditor.CodeGenerating;
...
using UnityEditor;
using UnityEngine;
using static SnowyEditor.Configs.LayerSetConfig;
...
namespace SnowyEditor.Window
{
    internal class LayerSetWindow : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            _listDrawer = new ListDrawer<LayerSetConfig.MaskField>(labelName, new LayerMaskFieldDrawer());
        }
        ...
        private class LayerMaskFieldDrawer : IListElementDrawer<LayerSetConfig.MaskField>
        {
            ...
            LayerSetConfig.MaskField IListElementDrawer<LayerSetConfig.MaskField>.OnDrawElement(Rect position, int index, LayerSetConfig.MaskField element, bool isActive, bool isFocused)
            {
